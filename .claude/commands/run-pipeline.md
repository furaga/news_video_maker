...
2. **記事をスコアリングして最良の1件を選定**:
   ...
   - 各記事を 1〜10 点でスコアリング。以下は**実際の再生数上位（top12）から抽出したパターン**に基づく加点・減点。上ほど効果が大きい:

   **加点要素（高視聴に繋がる傾向。top12の実例付き）:**
   - **消費者の損害・剥奪・強制**（手元の製品・権利・お金が奪われる/勝手に変わる）: **+3点**
     例: Sonyが購入済み映画551本を削除(13万再生) / ソニーがゲームディスクを完全廃止 / EUがスマホ電池交換を義務化 / 夢の固体電池が完全に嘘だった
   - **個人の体験・実話ストーリー形式**（「〇〇した話」「〇〇になった」「〇〇の1日」「去った理由」）: **+3点**
     例: 偶然ハッカーになって450万円もらった話 / 最強レーザーを撃った科学者の1日 / Mozillaに15年尽くした社員が去った理由
   - **具体的な数字・記録・金額が主役**（551本 / 19年 / 3000億円 / 7分 / 450万円 / 15年 のような固有数値）: **+2点**
   - **誰もが知る大企業・国が主語**（Sony / Google / Apple / Meta / Microsoft / EU / 中国 / アメリカ 等、日本の視聴者に馴染みが深い固有名詞）: **+2点**
   - **業界ドラマ**（著名人の辞任・抗議・対立・スキャンダル）: **+2点**
     例: Google幹部が「モラルを失った」と退職 / 中国がMetaの3000億円買収を阻止
   - **驚き・意外性・皮肉なオチ・逆説**（「夢の〇〇が実は嘘だった」型の裏切り）: **+1点**

   **減点要素（低視聴に繋がる傾向）:**
   - 人事異動・移籍・資金調達・クラウド戦略など、感情の起伏がなく「自分ごと」になりにくいネタ: **-2点**
   - 抽象的・汎用的すぎるテーマ（「〇〇の常識が変わった」など具体物・数字が乏しい）: **-2点**
   - 特定地域・ニッチ企業のニュースで日本人視聴者に馴染みが薄い: **-2点**
   - 製品レビュー・スペック紹介のみで人間ドラマがない: **-1点**
   - `past_titles` に含まれる過去記事と主題・企業・技術が重複または類似する場合は **-10点** のペナルティ（ネタ被り防止）

   採点した結果、最高スコアの記事を選定する（同点は「消費者の損害・剥奪」または「実話ストーリー」に該当する方を優先）
