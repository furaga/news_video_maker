...
**最優先**: 記事に具体的な数字・金額・記録があれば hook の冒頭に置く（例: 「たった2枚のGPUで、世界記録が塗り替えられました。」）。主語は Sony・Google など誰もが知る固有名詞にすると掴みが一段強くなる。**倫理方針**: 特定の企業・個人を貶める、不安・嫌悪を煽る書き方はしない。記事が本当にネガティブな内容の場合も、誇張せず事実として淡々と伝える。
