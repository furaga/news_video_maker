...
# 背景画像生成モデル（デフォルト: SDXL Turbo。ID に "xl" を含むと SDXL 用パラメータ、
# それ以外は SD1.5 用パラメータに自動で切り替わる。詳細は video/background.py 参照）
SD_MODEL_ID = os.getenv("SD_MODEL_ID", "Lykon/dreamshaper-xl-v2-turbo")
